...
public class BuyProducts extends javax.swing.JFrame {
   ...
   Connection conn;
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(937, 581));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String sql = "insert into Buy(Product_ID, Model_Name,Type,Price,Company,Warranty,Customer_ID,Name,Mobile_NO_OP,Mobile_NO_DG,Gender,Address,Status,DateOfRent) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
            pst=conn.prepareStatement(sql);
            pst.setString(1, jTextField1.getText());
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "Product Buy Complete");
